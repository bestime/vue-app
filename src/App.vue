...
<template>
  <NineSizeBox class="app-scale-outer" :uiWidth="1920" :uiHeight="1080" v-model:mode="state.scaleMode" :control="state.control">
...
import { NineSizeBox } from '@bestime/nine-ui-vue3'
